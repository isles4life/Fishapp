...
const styles = StyleSheet.create({
  ...
  backBtn: { width: 60 },
  backText: { ...typography.bodyMd, color: colors.accent, fontWeight: '600' },
  ...
  chevron: { ...typography.bodyMd, color: colors.accent, marginLeft: 8 },
  leaderboardPanel: {
  ...
  angler: { ...typography.bodyMd, color: colors.text, flex: 1 },
  length: { ...typography.numMd, color: colors.accent, width: 60, textAlign: 'right' },
  detailBtn: {
