  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: C.bg }}>
      ...
      <div style={{ maxWidth: 760, margin: '0 auto', padding: '40px 20px' }}>
            ...
            {entries.map((entry) => (
              <div key={entry.userId} style={{
                ...
                <div style={{
                  ...
                  color: rankColor(entry.rank), marginRight: 16, flexShrink: 0,
                }}>
                  {medalFor(entry.rank)}
                </div>
                <div style={{ flex: 1, fontWeight: 600, fontSize: 16, color: C.text }}>{entry.displayName}</div>
        ...
        {!loggedIn && (
          <div style={{
            marginTop: 48, backgroundColor: C.surface, borderRadius: 14,
            padding: 32, textAlign: 'center', border: `1px solid ${C.border}`,
          }}>
